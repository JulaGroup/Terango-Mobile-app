...
export default function SubscriptionScreen() {
  ...
  const fetchData = async () => {
    try {
      ...
      setPackages(
        packagesRes.data.packages.sort(
  ...
  const handleStartTrial = async () => {
    try {
      ...
      Alert.alert(
        "Trial Started!",
        response.data.message || "30-day trial activated"
      );
      fetchData();
    } catch (error: any) {
      Alert.alert(
            ...
            >
              <View style={styles.currentSubscriptionTop}>
                <View style={styles.currentSubscriptionTitleRow}>
                  <Ionicons
                    name={
                      getPackageIcon(currentSubscription.package.name) as any
                    }
                    size={32}
                    color="white"
                  />
              ...
              <View style={styles.detailRow}>
                ...
                <View style={styles.detailTextContainer}>
                  ...
                  <Text style={styles.detailValue}>
                    ...
                    {currentSubscription.package.price.toLocaleString()}
                  </Text>
                </View>
              </View>
                    ...
                    <View style={styles.usageBar}>
                      <View
                        style={[
                          ...
                          {
                            width: `${
                              (currentSubscription.productsUsed /
                                currentSubscription.package.maxProducts) *
                              100
                            }%`,
                          },
                ...
                <ScrollView style={styles.modalBody}>
                  ...
                  <View style={styles.modalFeaturesList}>
                    <View style={styles.modalFeatureItem}>
                      ...
                      <Text style={styles.modalFeatureText}>
                        {selectedPackage.maxProducts
                          ? `${selectedPackage.maxProducts} products`
                          : "Unlimited products"}
                      </Text>
                    </View>
                    ...
                    <View style={styles.modalFeatureItem}>
                      ...
                      />
                      <Text style={styles.modalFeatureText}>
                        {selectedPackage.supportLevel} support level
                      </Text>
                    </View>
                    ...
                    {selectedPackage.socialPostsPerMonth > 0 && (
                      <View style={styles.modalFeatureItem}>
                        ...
                        />
                        <Text style={styles.modalFeatureText}>
                          {selectedPackage.socialPostsPerMonth} social media
                          posts/month
                        </Text>
                      </View>
                    )}
                    ...
                    {selectedPackage.deliveryFeeDiscount > 0 && (
                      <View style={styles.modalFeatureItem}>
                        ...
                        />
                        <Text style={styles.modalFeatureText}>
                          {selectedPackage.deliveryFeeDiscount}% delivery fee
                          discount
                        </Text>
                      </View>
                    )}

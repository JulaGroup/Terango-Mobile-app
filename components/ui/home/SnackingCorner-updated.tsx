...
export default function SnackingCorner() {
  ...
  // "Snacking Corner" subcategory ID from your provided list
  const subcategoryId = "cm5ieyg3q000213i5nz9v8ht6";
  ...
  const fetchProducts = async () => {
    try {
      ...
      if (response.ok) {
        ...
        console.log('Snacking Corner products:', data);
      ...
      console.error('Error fetching snacking corner products:', error);
    } finally {
      setLoading(false);
    }
  };
  ...
  if (loading) {
    return (
      <View style={{ paddingVertical: 20, alignItems: 'center' }}>
        ...
        <Text style={{ marginTop: 10, color: '#6B7280' }}>Loading snacks...</Text>
      </View>
    );
  }
